...
import { ContactPersonDTO } from '../contract/responses/dto/contact-person.dto';
import { OrganizationAttachmentDTO } from '../contract/responses/dto/organization-attachment.dto';
