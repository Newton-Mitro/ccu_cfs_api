...
export class PersonFactory implements ModelSchemaFactory<Person, PersonModel> {
  create(model: PersonModel): Person {
  ...
  createFromSchema(entitySchema: Person): PersonModel {
