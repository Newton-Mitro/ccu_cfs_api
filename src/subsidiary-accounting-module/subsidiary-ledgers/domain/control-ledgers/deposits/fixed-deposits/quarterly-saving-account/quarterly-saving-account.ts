...
import { ITransferableSubsidiaryLedger } from 'src/subsidiary-accounting-module/subsidiary-ledgers/domain/interface/strategy/transferable-subsidiary-ledger.interface';
import { IWithdrawableSubsidiaryLedger } from 'src/subsidiary-accounting-module/subsidiary-ledgers/domain/interface/strategy/withdrawable-subsidiary-ledger.interface';
...
import { OpenLikeQuarterlySavingAccount } from './strategy/open-like-quarterly-saving-account';

export class QuarterlySavingAccount
  implements
    ...
    IWithdrawableSubsidiaryLedger
{
  ...
  constructor() {
    this.iOpenableSubsidiaryLedger = new OpenLikeQuarterlySavingAccount();
