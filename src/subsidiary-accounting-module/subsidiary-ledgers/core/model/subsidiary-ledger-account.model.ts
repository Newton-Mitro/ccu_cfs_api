...
export class SubsidiaryLedgerAccountModel {
  ...
  private Collaterals: CollateralModel[];
  ...
  public getCollaterals(): CollateralModel[] {
    return this.Collaterals;
  }

  public setCollaterals(collaterals: CollateralModel[]): void {
    this.Collaterals = collaterals;
  }

  public getSchedules(): ScheduleModel[] {
    return this.Schedules;
  }

  public setSchedules(schedules: ScheduleModel[]): void {
