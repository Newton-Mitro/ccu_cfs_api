...
import { CollateralStatus } from 'src/subsidiary-accounting-module/subsidiary-ledgers/domain/enum/collateral-status.enum';
import { CollateralType } from 'src/subsidiary-accounting-module/subsidiary-ledgers/domain/enum/collateral-type.enum';
