...
export class SavingAccountCommonOpeningPolicyValidator
  implements IPolicyValidator
{
  public ValidatePolicy(
    ...
    // [ ] 05. Collateral are not required for saving account opening.
    if (collaterals.length !== 0) {
      throw new BadRequestException('Collaterals is not applicable.');
    }

    // [ ] 06. Schedules are not required for saving account opening.
